...
Assume the prior distribution of $\theta$ is Normal with mean 98.6 and standard deviation 0.3.
...
# Plot
ggplot(data.frame(x = c(97.0, 99.5)), aes(x = x)) +
  # prior
  stat_function(
    fun = dnorm,
    args = list(mean = mu0, sd = tau0),
    lty = bayes_lty["prior"],
    linewidth = 1,
