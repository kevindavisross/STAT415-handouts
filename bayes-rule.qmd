...
One of the boxes is chosen uniformly at random (perhaps by rolling a fair six-sided die and subtracting 1 from the result), and then you will randomly select marbles from that box, without replacement.
