...
1. The probability that a Democratic candidate wins the 2028 U.S. Presidential election.
...
What is your subjective probability that Professor Ross has ever attended a "famous" sporting event (like the Superbowl, a World Series game 7, an NCAA tournament game with a famous shot, an Olympic final, etc)?
...
Suppose your subjective probabilities for the 2026 NBA champion satisfy the following conditions.

- The Nuggets and Spurs are equally likely to win
- The Celtics are 1.5 times more likely than the Nuggets to win
- The Thunder are 2 times more likely than the Celtics to win
- The winner is as likely to be among these four teams --- Thunder, Celtics, Spurs, Nuggets --- as not.
:::
...
How many miles are on the odometer of Professor Ross's car?
Consider mileage on a continous scale.

In this example, you will use probability to quantify your uncertainty about the mileage.
...
1.  What is your subjective probability that the mileage is at most 50000?
More than 50000?
(What must be true about these two probabilities?)
You're welcome to try with values other than 50000.
\
\
\

1. Fill in the blank: your subjective probability that the mileage is at most [blank] years old is equal to 50%.
\
\
\

1. Fill in the blanks: your subjective probability that the mileage is between [blank] and [blank] years old is equal to 98%.
\
\
\

1.  Let $\theta$ represent the current mileage.
...
Continuing the previous example, @fig-interpretations-four-densities displays the subjective probability distribution of mileage for four students.  
:::



![Plausibility assessments of four students](/figures/interpretation-four-densities-mileage.png){#fig-interpretations-four-densities}
...
1. Since mileage is treated as a continuous random variable, each of the above plots is a probability "density".
...
1. Rank the students in terms of their subjective probability that the mileage is at most 50000.
\
\
\
\
...
1. Rank the students in terms of their uncertainty about the mileage.  Who is the most uncertain?  The least?
\
\
\
\
...
Let $\theta_b$ represent the proportion of current Cal Poly students who have ever read at least one book in Lemony Snicket's *A Series of Unfortunate Events*. 
Let $\theta_m$ represent the proportion of current Cal Poly students who have seen at least one Star Wars movie.
:::
